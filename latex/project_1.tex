...
1). 
\begin{figure}%[htbp]
\centerline{\includegraphics{plots/exact.pdf}} %[bb = 0 0 200 100, draft, type=eps]
...
\begin{figure}
\centerline{\includegraphics{plots/exact-10-100-100000.pdf}} %[bb = 0 0 200 100, draft, type=eps]
...
\begin{figure}
\label{fig:error} \includegraphics[scale=0.7]{plots/errors.pdf} %[width=1\textwidth,bb = 0 0 200 100, draft, type=eps]
